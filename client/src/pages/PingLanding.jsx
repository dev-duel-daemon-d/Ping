        ...
        >
          ...
          <div className="relative animate-slide-in-right">
            <div className="relative w-full h-[400px] md:h-[600px]">
              ...
              {/* Stats Cards */}
              <div className="absolute mt-20 top-10 right-10 bg-black bg-opacity-70 backdrop-blur-lg rounded-2xl p-4 border border-lime-500 border-opacity-50 animate-slide-in-right animation-delay-1000 shadow-lg shadow-lime-500/30">
