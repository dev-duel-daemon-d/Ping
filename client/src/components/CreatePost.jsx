      ...
      <div className="flex gap-5">
        ...
        <div className="flex-1 min-w-0">
          <textarea
            ...
            placeholder={type === 'professional' ? "Share your achievements, clips, or find a team..." : "What's on your mind?"}
              ...
              {uploading && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                  <div className="bg-black/80 p-4 rounded-2xl flex flex-col items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-lime-500">Uploading...</span>
                  </div>
                </div>
              )}
            </div>
